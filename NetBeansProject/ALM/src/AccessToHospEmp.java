...
public class AccessToHospEmp extends javax.swing.JFrame {
    Connection con=null;
    ResultSet rs=null;
    PreparedStatement pst=null;
    public AccessToHospEmp() {
        initComponents();
    }
    private void reset()
{
    ...
    private void initComponents() {
        ...
        jPanel1.setFont(new java.awt.Font("Arial", 0, 19));
   ...
   try
    ...
    private void GetDataActionPerformed(java.awt.event.ActionEvent evt) {
      this.hide();
      LoginDetailsOfEmp ob1 = new LoginDetailsOfEmp();
      ob1.setVisible(true);        
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(AccessToHospEmp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AccessToHospEmp().setVisible(true);
            }
        });
    }
